...
func (h *Handler) RegisterRoutes(router *gin.Engine) {
	...
	protected.PATCH("/health/tasks/:taskID/status", h.updateCareTaskStatus)
	protected.DELETE("/health/tasks/:taskID", h.deleteCareTask)
	protected.GET("/alerts", h.listAlerts)
	protected.GET("/user/alerts", h.listAlerts)
	...
	protected.GET("/user/notifications/prefs", h.getNotificationPreferences)
	protected.PATCH("/user/notifications/prefs", h.patchNotificationPreferences)
